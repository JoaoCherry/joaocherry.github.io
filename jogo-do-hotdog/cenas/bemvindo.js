// Definindo a cena de boas-vindas com Phaser
class BemVindo extends Phaser.Scene {
    ...
    preload() {
        this.load.html("formulario", "formulario/form.html"); // Carregando o formulário HTML
        this.load.image("play", "assets/jogar.png"); // Carregando a imagem do botão de jogar
    }
    ...
    create() {
        ...
        var text = { height: 20, padding: 15, content: "Olá --" }
        var texto = { height: 10, padding: 7, content: "Divirta-se!"}
        ...
        this.inputName = this.add.dom(inputCoords.xposition, inputCoords.yposition).createFromCache('formulario').setOrigin(0, 0);
